<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/Manager.master" AutoEventWireup="true" CodeBehind="ChangePasswordM.aspx.cs" Inherits="DiagnosticCenter.PresentationLayer.WebForm5" %>
    ...
    <div style="height: 500px; width: 500px">
        ...
        <asp:Panel ID="panelChangePwd" runat="server" BackColor="Silver" Style="z-index: 101; position: absolute;
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                ...
                style="z-index: 1; left: 247px; top: 219px; position: absolute"></asp:CompareValidator>
            <br />
