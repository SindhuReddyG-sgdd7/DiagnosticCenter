<%@ Page Title="" Language="C#" MasterPageFile="~/PresentationLayer/Patient.master" AutoEventWireup="true" CodeBehind="ChangePasswordP.aspx.cs" Inherits="DiagnosticCenter.ChangePasswordP" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ChildContent2" runat="server">
    <div style="height: 500px; width: 500px">
        ...
        <asp:Label ID="lblChangePwd" runat="server" 
                style="z-index: 1; left: 170px; top: 27px; position: absolute" 
        ...
        <asp:Panel ID="panelChangePwd" runat="server" BackColor="Silver" Style="z-index: 101; position: absolute;
            ...
            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                ...
                style="z-index: 1; left: 242px; top: 220px; position: absolute; width: 170px"></asp:CompareValidator>
        </asp:Panel>
